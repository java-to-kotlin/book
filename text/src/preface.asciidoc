...
If you have a technical question or a problem using the code examples, [.keep-together]#please visit https://java-to-kotlin.dev[the book's website]# or send an email to pass:[<a class="email" href="mailto:bookquestions@oreilly.com"><em>bookquestions@oreilly.com</em></a>].
