...
<p>Kotlin has a special kind of procedure called an <span class="plain">extension function</plain>, that is called like a method but is in fact (usually) a top-level function.
