...
In our tests, though, the distinction is moot, and we could treat [.keep-together]#++recommendationsFor++# as a calculation in much the same way as we saw with [.keep-together]#++InMemoryTrips++# in <<actions-to-calculations>>.
