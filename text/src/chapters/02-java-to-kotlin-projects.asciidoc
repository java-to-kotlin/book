...
This has the advantage of providing better tool [.keep-together]#support# through strong typing, at the expense of having to translate historical StackOverflow answers into a new language.
