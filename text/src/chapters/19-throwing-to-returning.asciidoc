...
Unlike Java, where the order that we declare exceptions doesn't matter, ++Either<Exclu&#x2060;ded&#x200b;Excep&#x2060;tion, DuplicateException>++ is not the same thing as `Either<DuplicateException, ExcludedException>`.
