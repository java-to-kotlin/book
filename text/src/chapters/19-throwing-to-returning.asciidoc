...
Unlike Java, where the order that we declare exceptions doesn't matter, ++Either<Exclu&#x2060;ded&#x200b;Exception, DuplicateException>++ is not the same thing as `Either<DuplicateException, ExcludedException>`.
