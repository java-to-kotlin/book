...
Take((("MalformedURLException")))((("NumberFormatException"))) extracting data from a string for example: the `URL` constructor `URL(String)` throws the _checked_ `MalformedURLException`, while `Integer.parseInt(String)` throws the _unchecked_ `NumberFormatException`.
