...
This interpretation makes less sense for functions that have side effects, especially those that perform I/O or write to mutable state.
For instance:
...
We also prefer expressions as opposed to statements.
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.0/src/main/java/travelator/EmailAddress.kt">
        single-expressions.0:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
Before we go on, we should say that lots of the refactoring sequences presented in this book are of the form "Here's one I prepared earlier."
...
Because this is an otherwise small example, we've taken this opportunity to show what actually happened when we tried to convert `parse` to a single expression.
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.1/src/main/java/travelator/EmailAddress.kt">
        single-expressions.1:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.2/src/main/java/travelator/EmailAddress.kt">
        single-expressions.2:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.3/src/main/java/travelator/EmailAddress.kt">
        single-expressions.3:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.4/src/main/java/travelator/EmailAddress.kt">
        single-expressions.4:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.5/src/main/java/travelator/EmailAddress.kt">
        single-expressions.5:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.6/src/main/java/travelator/EmailAddress.kt">
        single-expressions.6:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.7/src/main/java/travelator/EmailAddress.kt">
        single-expressions.7:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.8/src/main/java/travelator/EmailAddress.kt">
        single-expressions.8:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.9/src/main/java/travelator/EmailAddress.kt">
        single-expressions.9:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.10/src/main/java/travelator/EmailAddress.kt">
        single-expressions.10:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.11/src/main/java/travelator/EmailAddress.kt">
        single-expressions.11:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.12/src/main/java/travelator/EmailAddress.kt">
        single-expressions.12:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.13/src/main/java/travelator/EmailAddress.kt">
        single-expressions.13:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.14/src/main/java/travelator/EmailAddress.kt">
        single-expressions.14:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.15/src/main/java/travelator/EmailAddress.kt">
        single-expressions.15:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.16/src/main/java/travelator/EmailAddress.kt">
        single-expressions.16:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.17/src/main/java/travelator/EmailAddress.kt">
        single-expressions.17:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.18/src/main/java/travelator/EmailAddress.kt">
        single-expressions.18:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.19/src/main/java/travelator/EmailAddress.kt">
        single-expressions.19:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.20/src/main/java/travelator/EmailAddress.kt">
        single-expressions.20:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.21/src/main/java/travelator/EmailAddress.kt">
        single-expressions.21:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://github.com/java-to-kotlin/code/blob/single-expressions.22/src/main/java/travelator/EmailAddress.kt">
        single-expressions.22:src/main/java/travelator/EmailAddress.kt
    </a>
</div>
++++
// end-insert
...
We explore how to support both languages' conventions during a gradual conversion from Kotlin to Java in <<functions-to-operators>>.
****

=== Moving On

Defining our calculations as single-expression functions lets us communicate that they are different from side-effecting actions.
...
At a deeper level, this chapter is about more than single expressions; it's about how we can rearrange our code without changing its behavior.
