...
Then there are _methods_, which are subroutines associated with an object (or a class, in the case of static [.keep-together]#methods#).
...
Where it's significant that they are associated with an object, we'll call them as [.keep-together]#methods#.
...
Methods, and the disguised methods that are member-properties, can also be [.keep-together]#calculations#:
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.1">Example 7.1 [actions.0:src/main/java/travelator/handlers/CurrentTripsHandler.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.1">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.2">Example 7.2 [actions.0:src/main/java/travelator/Tracking.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.2">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.3">Example 7.3 [actions.0:src/test/java/travelator/InMemoryTrips.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.3">(diff)</a> 
</div>
++++
// end-insert

The conversions from `Set<Trip>` (the result of `Trips.currentTripsFor`) and to `Optional<Trip>` (returned from `Tracking.currentTripFor`) seem to be because there is some business rule around there being only one active trip at any time—a rule that is not enforced in the persistence layer.
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.4">Example 7.4 [actions.1:src/test/java/travelator/InMemoryTrips.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.4">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.5">Example 7.5 [actions.2:src/test/java/travelator/InMemoryTrips.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.5">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.6">Example 7.6 [actions.0:src/test/java/travelator/TrackingTests.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.6">(diff)</a> 
</div>
++++
// end-insert
...
They fixed the tests with the refactoring in this chapter.
****

Is having to inject a clock https://oreil.ly/YZx1T[test-induced design damage]?
In this case it is.
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.7">Example 7.7 [actions.0:src/main/java/travelator/Trips.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.7">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.8">Example 7.8 [actions.3:src/main/java/travelator/Trips.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.8">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.9">Example 7.9 [actions.3:src/main/java/travelator/Tracking.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.9">(diff)</a> 
</div>
++++
// end-insert
...
`Tracking` isn't the outside of our interaction, so we select the `null` `Instant` and "Introduce Parameter" to add it to the signature of ++Tracking.&#x200b;cur&#x2060;rentTripFor++:
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.10">Example 7.10 [actions.4:src/main/java/travelator/Tracking.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.10">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.11">Example 7.11 [actions.4:src/main/java/travelator/handlers/CurrentTripsHandler.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.11">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.12">Example 7.12 [actions.4:src/test/java/travelator/TrackingTests.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.12">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.13">Example 7.13 [actions.4:src/test/java/travelator/InMemoryTrips.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.13">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.14">Example 7.14 [actions.5:src/test/java/travelator/InMemoryTrips.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.14">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.15">Example 7.15 [actions.5:src/test/java/travelator/TrackingTests.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.15">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.16">Example 7.16 [actions.6:src/test/java/travelator/TrackingTests.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.16">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.17">Example 7.17 [actions.8:src/test/java/travelator/TrackingTests.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.17">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.18">Example 7.18 [actions.8:src/main/java/travelator/handlers/CurrentTripsHandler.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.18">(diff)</a> 
</div>
++++
// end-insert
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.19">Example 7.19 [actions.9:src/main/java/travelator/handlers/CurrentTripsHandler.java]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.19">(diff)</a> 
</div>
++++
// end-insert
...
We are lucky and find that this passes the current time into its SQL query, so now we can just use the value of the `at` parameter in `Trips.currentTripsFor(String customerId, Instant at)` instead.
It would have been more complicated if the SQL query was using the current time of the database server from a database-specific expression such as `CURRENT_TIMESTAMP` or `NOW`.
...
If our query had used the database time, we would have to rewrite it to receive the time from our function as a parameter, and make a mental note not to make the same mistake again.
...
++++
<div class="coderef">
    <a class="orm:hideurl" href="https://java-to-kotlin.dev/code-links.html?ref=7.20">Example 7.20 [actions.10:src/test/java/travelator/InMemoryTrips.kt]</a> <a class="orm:hideurl print-hide" href="https://java-to-kotlin.dev/code-links.html?diff=7.20">(diff)</a> 
</div>
++++
// end-insert
...
In this respect our `InMemoryTrips` is less safe than our database implementation because, if accessed on multiple threads, it can mutate the collection returned by `tripsFor`, leading to potential ++ConcurrentModification&#x200b;Excep&#x2060;tions++ in the `filter` implementation.
