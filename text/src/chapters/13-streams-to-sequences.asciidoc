...
We named intermediate variables, and specified their types when and only when it seemed to help, and formatted carefully—and it still looks like someone knocked the code on the floor and tried to put it back together in the hope that we didn't notice.
