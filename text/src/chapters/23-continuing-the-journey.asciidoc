...
Instead, we discovered that a certain style of [.keep-together]#programming#—object orientation but with immutable objects—was expressive and understandable, refactorable and safe.
