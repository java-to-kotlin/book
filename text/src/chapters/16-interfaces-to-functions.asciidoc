...
`RecommendationsTests` uses mocks to provide implementations of its ++Distance&#x200b;Cal&#x2060;cula&#x2060;tor++ and `FeaturedDestinations`, which are passed to the instance of `Recommendations` under test:
